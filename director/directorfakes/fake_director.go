...
type FakeDirector struct {
	...
	LatestConfigStub        func() (director.Config, error)
...
func (fake *FakeDirector) LatestConfig() (director.Config, error) {
	...
	fake.recordInvocation("LatestConfig", []interface{}{})
	fake.latestConfigMutex.Unlock()
	if fake.LatestConfigStub != nil {
		return fake.LatestConfigStub()
	}
	if specificReturn {
		return ret.result1, ret.result2
	}
